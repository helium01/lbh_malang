              ...
              <div class="card-body">
                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                  <div class="row">
                    <div class="col-sm-12 col-md-6">
                      <div class="dt-buttons btn-group flex-wrap">
                        <a class="btn btn-primary buttons-copy buttons-html5" tabindex="0" href="{{route('pengacara.create')}}"><span>tambah data pengacara</span></a> 
                  ...
                  <tr>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">biografi</th>
                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">foto</th>
                  ...
                  <tr class="odd"> 
                    ...
                    <td>
                        <a href="{{route('pengacara.edit',$dt->id)}}" class="btn btn-block btn-primary"> edit</a>
                        <a href="{{route('pengacara.destroy',$dt->id)}}" class="btn btn-block btn-danger"> hapus</a>
                    </td>
                  </tr> 
                  @endforeach
                </tbody>
