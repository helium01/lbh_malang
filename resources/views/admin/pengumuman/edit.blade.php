              ...
              <form method="post" action="{{route('pengumuman.update',$pengumuman->id)}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="judul" class="form-control" id="exampleInputEmail1" placeholder="masukan judul" value="{{$pengumuman->judul}}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <img src="{{asset('foto/'.$pengumuman->foto)}}" width="300" alt="">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="" cols="30" rows="10">{{$pengumuman->deskripsi}}</textarea>
                  </div>
                </div>
                <!-- /.card-body -->
