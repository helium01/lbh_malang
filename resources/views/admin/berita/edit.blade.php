              ...
              <form method="post" action="{{route('berita.update',$berita->id)}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="judul" class="form-control" id="exampleInputEmail1" value="{{$berita->judul}}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="" cols="30" rows="10">{{$berita->deskripsi}}</textarea>
                  </div>
                </div>
                <!-- /.card-body -->
