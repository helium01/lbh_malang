              ...
              <form method="post" action="{{route('kegiatan.update',$kegiatan->id)}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="judul" class="form-control" id="exampleInputEmail1" placeholder="masukan judul" value="{{$kegiatan->judul}}">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <img src="{{asset('foto/'.$kegiatan->foto)}}" alt="" width="300" >
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="deskripsi" id="" cols="30" rows="10" class="form-control">{{$kegiatan->deskripsi}}</textarea>
                  </div>
                </div>
                <!-- /.card-body -->
